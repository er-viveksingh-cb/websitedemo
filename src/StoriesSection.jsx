...
export default function StoriesSection() {
  ...
  // compute card minWidth dynamically:
  // mobile: calc(100% - 48px) => leaves ~24px gutter each side (peek)
  // tablet: show 2 cards (320px)
  // desktop: show bigger cards (503px)
  const getCardStyle = () => {
    if (winWidth < 640) {
  ...
  const scrollByOne = (dir = 1) => {
    ...
    // grab first visible card to find width (reliable)
    ...
    <section className="bg-white pt-[84px] mx-0 px-4 md:px-[80px] lg:px-[120px] pb-[60px]">
      <div className="mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-6">
          <div>
            <span className="inline-block text-xs md:text-sm bg-blue-100 text-blue-700 px-3 py-1 rounded-full">
              Real Stories. Real Miracles.
            </span>
            <h2 className="mt-4 text-2xl md:text-4xl font-light text-gray-900 leading-tight">
        ...
        <div
          ...
          style={{
            // hide scrollbar in a graceful cross-browser way:
        ...
        >
          {stories.map((story) => (
            <div
              ...
              style={{
                // inline width/height needed for precise "peek" behaviour on mobile
        ...
        {/* mobile 'See all' button under carousel for small screens */}
