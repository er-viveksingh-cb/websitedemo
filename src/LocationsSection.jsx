...
import Locationimage from "./location.png"; // ensure file exists (rename to remove spaces)
...
const locations = [
  ...
  },
  {
    ...
    image: Locationimage, // swap with real image path for Pune if available
  },
  {
    city: "Nashik",
    address:
      ...
      <div className=" mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-8">
              ...
              >
                ...
                <div
                  className={`w-10 h-10 flex items-center justify-center rounded-full ${
                    activeIndex === idx ? "bg-blue-600 text-white" : "bg-black text-white"
                  }`}
                >
                  ↗
                </div>
          ...
          <div className="w-full md:w-2/3">
            ...
            {/* Info card (light background) - positioned directly under image */}
            <div className="mt-4 bg-gray-50 rounded-2xl p-5 md:p-6 shadow-inner relative">
              {/* Arrow button top-right (overlapping) */}
            ...
            {/* Mobile: small horizontal list under info card so user can quickly tap other centers */}
              ...
              <div className="flex gap-3 overflow-x-auto pb-1">
                {locations.map((loc, idx) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-500 mt-1 line-clamp-2" style={{ WebkitLineClamp: 2 }}>
                      {loc.address}
                    </div>
                  </button>
                ))}
